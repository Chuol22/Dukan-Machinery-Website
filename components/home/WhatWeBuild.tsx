  ...
  const features = [
    {
      ...
      description:
        "Precision-engineered systems that deliver exact output requirements consistently.",
      icon: CapacityIcon,
      animation: "fade-left",
    },
    {
      ...
      description:
        "Built with high-grade industrial steel for long-term operational.",
      icon: DurabilityIcon,
      animation: "fade-up",
    },
    {
      ...
      description:
        "Fully compliant with global engineering protocols and local safety regulations.",
      icon: StandardsIcon,
      animation: "fade-down",
    },
    {
      ...
      description:
        "Dedicated technical assistance and parts availability to minimize downtime.",
      icon: SupportIcon,
