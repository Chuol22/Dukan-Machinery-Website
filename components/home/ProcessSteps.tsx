...
export default function ProcessSteps() {
  ...
  return (
    <section 
      ref={ref} 
      id="process"
      className="py-24 bg-green-50 dark:bg-green-900/50 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-green-900 dark:text-white tracking-tight uppercase">
            Our Working Process
          </h2>
                ...
                <div className="flex flex-col items-center  text-center">
                  ...
                  <div className="relative mb-6">
                    <motion.div
                      ...
                      className="w-24 h-24 rounded-2xl bg-white dark:bg-gray-800 shadow-xl flex items-center justify-center border-b-4 border-green-700 group-hover:bg-green-700 transition-all duration-300 animate-float"
                    >
                      <step.icon className="w-10 h-10 text-green-700 group-hover:text-white transition-colors duration-300 " />
                    </motion.div>
                    
                    {/* Step Number Badge */}
                    <div className="absolute -top-4 -right-4 w-10 h-10 rounded-full bg-orange-500 text-white flex items-center justify-center font-black text-sm border-4 border-gray-50 dark:border-gray-900 shadow-lg animate-pulse-slow">
                      {step.step}
                    </div>
                  </div>

                  {/* Title */}
                  <h3 className="text-xl font-black text-orange-600 dark:text-orange-400 mb-3 uppercase">
                    {step.title}
                  </h3>
