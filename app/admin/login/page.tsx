...
export default function AdminLoginPage() {
  ...
  const [role, setRole] = useState<"SUPER_ADMIN" | "SALES_OFFICER">(
    "SUPER_ADMIN",
  );
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950 px-4 py-12 relative overflow-hidden">
      ...
      <div
        className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-green-400/20 dark:bg-green-600/10 rounded-full blur-3xl -z-10 animate-float"
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link
            href="/"
            className="inline-flex flex-col items-center space-y-1 group"
          >
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2 bg-gray-100 dark:bg-gray-800/80 p-1.5 rounded-xl border border-gray-200/50 dark:border-gray-800">
                <button
                  ...
                  onClick={() => {
                    setRole("SUPER_ADMIN");
                    if (email === "sarah@dukanmachinery.com")
                      setEmail("john@dukanmachinery.com");
                  }}
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    if (email === "admin@dukanmachinery.com")
                      setEmail("officer@dukanmachinery.com");
                  }}
                  className={`py-2 px-3 text-xs font-bold rounded-lg transition-all ${
                    role === "SALES_OFFICER"
                      ? "bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm"
            ...
            <div>
              ...
              <div className="relative rounded-xl shadow-sm">
                ...
                <input
                  ...
                  placeholder={
                    role === "SUPER_ADMIN"
                      ? "admin@dukanmachinery.com"
                      : "officer@dukanmachinery.com"
                  }
                  value={email}
