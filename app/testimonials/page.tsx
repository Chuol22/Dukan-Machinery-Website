...
const testimonials = [
  {
    ...
    content:
      "The Poultry Feed Machine we installed has exceeded our expectations. The pellet quality is consistent, and the energy efficiency is remarkable.",
    rating: 5,
    company: "Geze Poultry Farms",
    date: "2024-01-15",
    project:
      "Complete poultry feed production line installation with capacity of 15 tons/day.",
  },
  {
    id: 2,
    name: "Hayu Samuel",
    ...
    content:
      "Dukan Machinery provided exceptional support during the setup of our cattle feed line. Their technical team is truly professional and knowledgeable.",
    rating: 5,
    company: "Kebede Agritech",
    date: "2024-02-20",
    project:
      "Custom cattle feed processing plant with automated mixing and pelleting systems.",
  },
  {
    id: 3,
    name: "Meti solomon",
    ...
    content:
      "Finding reliable custom industrial machines is tough, but Dukan's engineering standards are top-tier. They understand the nuances of feed processing.",
    rating: 5,
  ...
  },
  {
    ...
    content:
      "The hammer mill we purchased has been running continuously for 18 months with zero downtime. Outstanding build quality.",
    rating: 5,
          ...
          <div className="container mx-auto px-4">
              ...
              {testimonials.map((testimonial) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-4 border-t border-gray-100 dark:border-gray-700 pt-5">
                    ...
                    <ChevronRight
                      className={`w-5 h-5 text-gray-400 transition-transform duration-300 ${expandedId === testimonial.id ? "rotate-90" : ""}`}
                    />
                  </div>
            ...
            >
              <p className="text-gray-400 dark:text-gray-500 text-sm font-semibold uppercase tracking-wider">
                Trusted by <span className="text-orange-500">200+</span>{" "}
                enterprises and farmers nationwide
              </p>
            </motion.div>
            ...
            >
              <div className="bg-linear-to-r from-orange-500 to-orange-600 rounded-2xl p-10 text-white text-center">
                ...
                <p className="mb-6 opacity-90 max-w-2xl mx-auto">
                  Experience the same quality and reliability that our clients
                  trust. Let&apos;s discuss how we can transform your production
                  line.
                </p>
                <a
                  href="/contact"
          ...
          <div className="container mx-auto px-4">
            ...
            >
              {[
                {
                  name: "NATC",
                  title: "National Agricultural Training Center",
                  desc: "Certified Partner",
                },
                {
                  name: "ISO",
                  title: "Certified Agro-Processing",
                ...
                <div
                  key={idx}
                  className="bg-white dark:bg-gray-800 rounded-2xl p-6 text-center hover:shadow-lg transition-all duration-300"
                >
