  ...
  try {
    ...
    const machines = data.map((m) => {
      ...
      return {
        ...
        extractionRate: specifications?.extractionRate || staticMachine?.extractionRate || "",
        waterConsumption: specifications?.waterConsumption || staticMachine?.waterConsumption || "",
