...
export default function MachinesPage() {
    ...
    const loadCatalog = async () => {
      try {
        ...
        setCategories([
          "All",
          ...Array.from(
            new Set(machinesData.map((machine) => machine.category)),
          ),
        ]);
      }
    };
  ...
  const filteredMachines = machines.filter((machine) => {
    ...
    const matchesStage =
      selectedStage === "All" || machine.type === selectedStage;
    ...
    if (selectedCapacity !== "All") {
      ...
      if (selectedCapacity === "Small (<500 kg/hr)")
        matchesCapacity = capacityValue < 500;
      else if (selectedCapacity === "Medium (500-2000 kg/hr)")
        matchesCapacity = capacityValue >= 500 && capacityValue <= 2000;
      else if (selectedCapacity === "Large (>2000 kg/hr)")
        matchesCapacity = capacityValue > 2000;
    }
    ...
    <div className="min-h-screen bg-white dark:bg-gray-800">
      ...
      <section className="relative bg-green-50 dark:bg-gray-900 text-gray-900 dark:text-white py-16 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Explore our range of high-performance agricultural and industrial
