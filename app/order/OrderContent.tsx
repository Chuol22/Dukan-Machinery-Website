...
type OrderSummaryData = StandardOrderSubmitData & {
...
export default function OrderContent() {
  ...
  const handleStandardOrderSubmit = (data: StandardOrderSubmitData) => {
    setOrderData({ ...data, type: 'standard' });
    setShowSummary(true);
  };

  const handleCustomOrderSubmit = (data: unknown) => {
    // Keep existing behavior; OrderSummary currently expects standard fields or generic.
    setOrderData({ ...(data as StandardOrderSubmitData), type: 'custom' });
    setShowSummary(true);
  };
